...
object Dependencies {
  ...
  lazy val redisson = "org.redisson" % "redisson" % "3.17.0"

  lazy val endpoints = "org.endpoints4s" %% "algebra" % "1.7.0"
  lazy val endpointsCirce = "org.endpoints4s" %% "algebra-circe"  % "2.1.0"

  lazy val http4sServer = "org.http4s" %% "http4s-blaze-server" % "0.23.11"
  lazy val http4sClient = "org.http4s" %% "http4s-blaze-client" % "0.23.11"
  lazy val http4sDsl = "org.http4s" %% "http4s-dsl" % "0.23.11"
  ...
  lazy val http4sCirce = "org.http4s" %% "http4s-circe" % "0.23.11"
